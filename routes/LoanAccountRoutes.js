...
router.post('/reject', LoanAccountController.rejectLoanApplication);
...
router.post('/approve-disbursement', LoanAccountController.approveLoanDisbursement); // Fixed route
...
router.get('/customer/:custId', LoanAccountController.getLoanAccountsByCustomerId);
...
router.post('/approve', approveLoanWithGuarantor);
