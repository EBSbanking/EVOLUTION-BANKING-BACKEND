...
This agreement constitutes a legally binding contract between the borrower and the bank.`;
  ...
  async approveLoanApplication(req, res) {
    ...
    try {
      ...
      const normalizedCustId = rawCustId.replace(/^0+/, '');
      ...
      await LoanAccount.updateOne(
        { _id: loanAccount._id },
        {
          $set: {
            ...
            TRANSACTION_ID: workflowIdentifiers.TRANSACTION_ID,
            EVENT_ID: workflowIdentifiers.EVENT_ID,
            JOURNAL_ID: workflowIdentifiers.TRAN_JOURNAL_ID,
            lastUpdated: new Date()
          }
        },
        { session }
      ...
      await CreditApplication.updateOne(
        { _id: creditApplication._id },
        {
          $set: {
            ...
            TRANSACTION_ID: workflowIdentifiers.TRANSACTION_ID,
            EVENT_ID: workflowIdentifiers.EVENT_ID,
            REPAY_SRC_ACCT_NO: repaymentAccount.ACCT_NO
          }
        },
        { session }
      );
      ...
      return res.status(200).json({
        ...
        data: {
          ...
          workflowIdentifiers: workflowIdentifiers
        }
      });
