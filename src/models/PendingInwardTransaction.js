...
class PendingInwardTransaction extends Model {}

PendingInwardTransaction.init({
  INWD_FUNDS_XFER_ID: {
  ...
  sequelize,
  modelName: 'PendingInwardTransaction',
  tableName: 'PendingInwardTransaction', // Sequelize will pluralize the model name
...
export default PendingInwardTransaction;
