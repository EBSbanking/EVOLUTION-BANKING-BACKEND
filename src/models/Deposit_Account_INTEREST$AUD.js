...
const DepositAccountInterestAudit = mongoose.model('DepositAccountInterestAudit', depositAccountInterestAuditSchema, 'deposit_account_interest_aud'); // Updated collection name
