...
export const ROLE_PERMISSION_MAPPING = {
  ...
  // 28. Credit Officer - UPDATED WITH LOAN REPAYMENT PERMISSIONS
  28: {
    permissions: {
      ...
      LOAN_OPERATIONS_ACCESS_LEVEL: [
        ...
        PERMISSIONS.LOAN_OPERATIONS.VIEW,
        PERMISSIONS.LOAN_OPERATIONS.PROCESS,
        // INCLUDED: Loan Repayment/Collection Permissions
        PERMISSIONS.LOAN_OPERATIONS.COLLECT,
      ...
      // INCLUDED: Other Relevant Permissions (e.g., for Loan Repayment Monitoring)
      PERFORMANCE: [
      ...
      REPORT: [
        ...
        PERMISSIONS.REPORT.VIEW_LOAN_REPORT, // Assuming a loan-specific report perm exists or can be added
        // ✅ ADDED: Repayment reports
        PERMISSIONS.REPORT.LOAN_REPAYMENT,
      ],
      // ✅ ADDED: Full loan repayment access for credit officer
      LOAN_REPAYMENT_ACCESS_LEVEL: safeGetPermissions(PERMISSIONS.LOAN_REPAYMENT),
      GROUP_LOAN_ACCESS_LEVEL: [
        PERMISSIONS.GROUP_LOAN.VIEW,
        PERMISSIONS.GROUP_LOAN.PROCESS_REPAYMENT,
  ...
  // 29. Teller - UPDATED WITH LOAN REPAYMENT PERMISSIONS
  29: {
    permissions: {
      DRAWER_ACCESS_LEVEL: [
      ...
      // INCLUDED: Loan Repayment Permissions (Limited for Teller Role)
      LOAN_OPERATIONS_ACCESS_LEVEL: [
        PERMISSIONS.LOAN_OPERATIONS.COLLECT, // Basic collection/repayment
        PERMISSIONS.LOAN_OPERATIONS.VIEW, // View loan details for repayment
      ],
      // INCLUDED: Other Relevant Permissions (e.g., for Transaction-Related Repayments)
      TRANSACTION: [
        PERMISSIONS.TRANSACTION.APPROVE, // Approve repayments
        PERMISSIONS.TRANSACTION.CANCEL, // Cancel erroneous repayments
      ],
      PERFORMANCE: [
        PERMISSIONS.PERFORMANCE.VIEW_TELLER_PERFORMANCE, // Monitor own repayment performance
        // ✅ ADDED: Teller repayment performance
        PERMISSIONS.PERFORMANCE.LOAN_REPAYMENT_PERFORMANCE,
      ],
      // ✅ ADDED: Limited repayment access
      LOAN_REPAYMENT_ACCESS_LEVEL: [
        PERMISSIONS.LOAN_REPAYMENT.MANUAL,
        PERMISSIONS.LOAN_REPAYMENT.PROCESS,
